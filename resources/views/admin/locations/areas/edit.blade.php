...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-geo-alt me-2"></i>Edit Area</h4>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <form id="areaForm" method="POST" action="{{ route('admin.locations.areas.update', $area->id) }}">
                    @csrf @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="sort_order" name="sort_order" class="form-control" value="{{ old('sort_order', $area->sort_order) }}" min="0">
                    </div>
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ old('is_active', $area->is_active) ? 'checked' : '' }}>
...
<div class="floating-save-container">
    ...
    <form action="{{ route('admin.locations.areas.destroy', $area->id) }}" method="POST" class="d-inline">
        @csrf @method('DELETE')
        <button type="submit" class="btn btn-outline-danger floating-reset-btn" onclick="return confirm('Delete this area?')">
            <i class="bi bi-trash me-1"></i> Delete
        </button>
    </form>
    <button type="submit" form="areaForm" class="btn btn-primary floating-save-btn">
        <i class="bi bi-check-lg me-1"></i> Update Area
    </button>
</div>
@endsection
