    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Leave empty to keep current image. Recommended size: 1920x600px.</div>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="show_title" name="show_title" value="1" {{ old('show_title', $slider->show_title) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="show_subtitle" name="show_subtitle" value="1" {{ old('show_subtitle', $slider->show_subtitle) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="show_button" name="show_button" value="1" {{ old('show_button', $slider->show_button) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input" type="checkbox" id="show_gradient" name="show_gradient" value="1" {{ old('show_gradient', $slider->show_gradient) ? 'checked' : '' }}>
