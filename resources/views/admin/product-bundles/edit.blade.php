...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Edit Product Bundle</h4>
...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <form action="{{ route('admin.product-bundles.update', $productBundle->id) }}" method="POST" enctype="multipart/form-data" id="bundleForm">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-3">
                        <label for="name" class="form-label">Bundle Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $productBundle->name) }}" required placeholder="e.g., Summer Essentials Bundle">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $productBundle->slug) }}" placeholder="auto-generated-if-empty">
                        </div>
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Describe this bundle...">{{ old('description', $productBundle->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div id="selectedProductsContainer">
                    ...
                    <div class="text-center text-muted py-4" id="noProductsMessage" style="display: none;">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('bundle_price') is-invalid @enderror" id="bundle_price" name="bundle_price" value="{{ old('bundle_price', $productBundle->bundle_price) }}" min="0" step="0.01" form="bundleForm">
                        </div>
                        @error('bundle_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select @error('discount_type') is-invalid @enderror" id="discount_type" name="discount_type" form="bundleForm">
                            <option value="percentage" {{ old('discount_type', $productBundle->discount_type) === 'percentage' ? 'selected' : '' }}>Percentage</option>
                            <option value="fixed" {{ old('discount_type', $productBundle->discount_type) === 'fixed' ? 'selected' : '' }}>Fixed Amount</option>
                        </select>
                        @error('discount_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('discount_value') is-invalid @enderror" id="discount_value" name="discount_value" value="{{ old('discount_value', $productBundle->discount_value) }}" min="0" step="0.01" form="bundleForm">
                            <span class="input-group-text" id="discountSuffix">{{ $productBundle->discount_type === 'percentage' ? '%' : '$' }}</span>
                        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('starts_at') is-invalid @enderror" id="starts_at" name="starts_at" value="{{ old('starts_at', $productBundle->starts_at?->format('Y-m-d\TH:i')) }}" form="bundleForm">
                        @error('starts_at')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('expires_at') is-invalid @enderror" id="expires_at" name="expires_at" value="{{ old('expires_at', $productBundle->expires_at?->format('Y-m-d\TH:i')) }}" form="bundleForm">
                        @error('expires_at')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_purchases') is-invalid @enderror" id="max_purchases" name="max_purchases" value="{{ old('max_purchases', $productBundle->max_purchases) }}" min="1" placeholder="Unlimited" form="bundleForm">
                        @error('max_purchases')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_purchases_per_user') is-invalid @enderror" id="max_purchases_per_user" name="max_purchases_per_user" value="{{ old('max_purchases_per_user', $productBundle->max_purchases_per_user) }}" min="1" placeholder="Unlimited" form="bundleForm">
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('meta_title') is-invalid @enderror" id="meta_title" name="meta_title" value="{{ old('meta_title', $productBundle->meta_title) }}" placeholder="SEO title for search engines" form="bundleForm">
                    @error('meta_title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" name="meta_description" rows="3" placeholder="SEO description for search engines" form="bundleForm">{{ old('meta_description', $productBundle->meta_description) }}</textarea>
    ...
    <div class="col-lg-4">
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <div class="image-upload-preview mb-2 text-center" id="imagePreview" {{ $productBundle->featured_image ? '' : 'style="display: none;"' }}>
                        <img src="{{ $productBundle->featured_image ? asset('storage/' . $productBundle->featured_image) : '' }}" alt="Preview" class="img-thumbnail" style="max-width: 100%; max-height: 200px;">
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $productBundle->is_active) ? 'checked' : '' }} form="bundleForm">
                ...
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" {{ old('is_featured', $productBundle->is_featured) ? 'checked' : '' }} form="bundleForm">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" name="sort_order" value="{{ old('sort_order', $productBundle->sort_order) }}" min="0" form="bundleForm">
                    @error('sort_order')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <strong>{{ $productBundle->remaining_purchases ?? 0 }} / {{ $productBundle->max_purchases }}</strong>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm border-danger">
            ...
            <div class="card-body">
                <p class="text-muted small mb-2">Deleting this bundle cannot be undone. All associated data will be permanently removed.</p>
                <form action="{{ route('admin.product-bundles.destroy', $productBundle->id) }}" method="POST" id="deleteForm">
                    @csrf
                    @method('DELETE')
                    <button type="button" class="btn btn-outline-danger btn-sm w-100" onclick="confirmDelete()">
                        <i class="bi bi-trash me-1"></i> Delete Bundle
                    </button>
                </form>
            </div>
        </div>
...
<div class="floating-save-container">
    ...
    <button type="submit" form="bundleForm" class="btn btn-primary floating-save-btn">
        <i class="bi bi-check-lg me-1"></i> Update Bundle
    </button>
</div>
