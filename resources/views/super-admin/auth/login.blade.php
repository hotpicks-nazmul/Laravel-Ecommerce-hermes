        ...
        <div class="text-center mb-8">
            <a href="{{ route('home') }}" class="inline-block">
                <h1 class="text-3xl font-bold text-halal-green">
                    <i class="bi bi-shield-check me-2"></i>{{ config('app.name') }}
                </h1>
            </a>
            <p class="text-gray-500 mt-2">Super Admin Panel</p>
        </div>

        <!-- Login Card -->
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h2 class="text-2xl font-bold text-center mb-6">Super Admin Login</h2>
            ...
            <form method="POST" action="{{ route('super-admin.login.post') }}">
                ...
                <button type="submit" 
                    ...
                    <i class="bi bi-box-arrow-in-right me-2"></i> Login as Super Admin
                </button>
            </form>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-500 text-sm">
                    Different role?
                    <a href="{{ route('admin.login') }}" class="text-halal-green hover:underline">Admin Login</a>
                    |
