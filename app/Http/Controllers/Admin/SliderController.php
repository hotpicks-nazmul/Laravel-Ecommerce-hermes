...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'show_subtitle' => 'nullable|in:0,1',
            'show_button' => 'nullable|in:0,1',
            'show_gradient' => 'nullable|in:0,1',
        ]);
        ...
        $data['show_subtitle'] = $request->has('show_subtitle');
        $data['show_button'] = $request->has('show_button');
        $data['show_gradient'] = $request->has('show_gradient');
