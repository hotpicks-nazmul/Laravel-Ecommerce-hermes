...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('register.post') }}" method="POST">
            ...
            <div class="rounded-md shadow-sm space-y-4">
                <div>
                    ...
                    <input id="name" name="name" type="text" required
                        class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-halal-green focus:border-halal-green focus:z-10 sm:text-sm"
            ...
            <div>
                <button type="submit"
                    class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-halal-green hover:bg-halal-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-halal-green">
