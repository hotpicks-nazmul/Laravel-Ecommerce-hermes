...
<div class="card border-0 shadow-sm">
    <div class="card-body p-0">
        ...
        <div class="media-grid p-3" id="mediaGrid">
            ...
            <div class="media-item" data-path="{{ $file['path'] }}" onclick="toggleSelect(event, '{{ $file['path'] }}')">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <button class="btn btn-outline-primary" onclick="copyUrl(document.getElementById('modalUrl').value)">
                                    <i class="bi bi-clipboard"></i>
                                </button>
                            </div>
                        </div>
...
function toggleSelect(event, path) {
    if (event.target.type === 'checkbox' || event.target.closest('.actions')) return;
    alert('Click the checkbox or action buttons to interact with files.');
}
