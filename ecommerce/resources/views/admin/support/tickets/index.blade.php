            ...
            <div class="col-md-2 col-sm-4 col-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <div class="h4 mb-0 text-primary">{{ $stats['open'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 col-6 mb-3">
            ...
            <div class="col-md-2 col-sm-4 col-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <div class="h4 mb-0 text-info">{{ $stats['open'] ?? 0 - $stats['pending'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 col-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        <div class="text-muted small text-uppercase">Solved</div>
                        <div class="h4 mb-0 text-success">{{ $stats['solved'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-2 col-sm-4 col-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <div class="h4 mb-0 text-secondary">{{ $stats['closed'] ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function deleteTicket(id) {
        ...
        form.action = `{{ route('admin.support.tickets.index') }}/` + id;
