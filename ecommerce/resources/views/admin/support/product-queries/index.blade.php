...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="bi bi-question-circle me-2"></i>Product Queries</h4>
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                ...
                                <p class="text-muted mt-2">No product queries found</p>
                                <p class="text-muted small">Customer questions about products will appear here</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
