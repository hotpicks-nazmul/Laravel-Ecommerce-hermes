                ...
                <form id="bannerForm" method="POST" action="{{ route('admin.affiliate.banners.update', $banner->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="width" name="width" value="{{ old('width', $banner->width) }}" min="1">
                        </div>
                        <div class="col-md-4">
                            <label for="height" class="form-label">Height (px)</label>
                            <input type="number" class="form-control" id="height" name="height" value="{{ old('height', $banner->height) }}" min="1">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" class="form-control" id="target_url" name="target_url" value="{{ old('target_url', $banner->target_url) }}">
                            </div>
                        </div>
                        <div class="col-md-6">
