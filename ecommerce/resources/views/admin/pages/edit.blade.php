        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('pages.show', $page->slug) }}" target="_blank" class="btn btn-outline-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.pages.update', $page->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Slug is auto-generated from the title</small>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" name="is_active" class="form-check-input" id="isActive" 
                                       value="1" {{ old('is_active', $page->status === 'published') ? 'checked' : '' }}>
