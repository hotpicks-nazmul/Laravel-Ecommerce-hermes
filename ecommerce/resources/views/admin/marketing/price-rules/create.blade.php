...
@section('title', 'Add Price Rule')

@section('content')
<!-- Header -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Add Price Rule</h4>
...
<form method="POST" action="{{ route('admin.marketing.price-rules.store') }}" id="itemForm">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" id="max_discount_amount" name="max_discount_amount" class="form-control @error('max_discount_amount') is-invalid @enderror" value="{{ old('max_discount_amount') }}" step="0.01" min="0" placeholder="Optional">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" id="min_quantity" name="min_quantity" class="form-control @error('min_quantity') is-invalid @enderror" value="{{ old('min_quantity', 1) }}" min="1">
                            @error('min_quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @else
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="min_order_amount" name="min_order_amount" class="form-control @error('min_order_amount') is-invalid @enderror" value="{{ old('min_order_amount') }}" step="0.01" min="0" placeholder="Optional">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-check">
                                <input class="form-check-input category-checkbox" type="checkbox" name="category_ids[]" value="{{ $category->id }}" id="category_{{ $category->id }}" {{ is_array(old('category_ids')) && in_array($category->id, old('category_ids')) ? 'checked' : '' }}>
                            ...
                            @if($category->children && $category->children->count() > 0)
                                ...
                                <div class="form-check ms-4">
                                    <input class="form-check-input category-checkbox" type="checkbox" name="category_ids[]" value="{{ $child->id }}" id="category_{{ $child->id }}" {{ is_array(old('category_ids')) && in_array($child->id, old('category_ids')) ? 'checked' : '' }}>
            ...
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="number" id="priority" name="priority" class="form-control @error('priority') is-invalid @enderror" value="{{ old('priority', 0) }}" min="0">
                        @error('priority')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
            ...
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body">
                    <div id="discountPreview">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <span>Discount:</span>
                            <span class="text-success fw-bold" id="previewDiscount">- $0.00</span>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between">
                            <span>Final Price:</span>
                            <span class="fw-bold" id="previewFinal">$100.00</span>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="floating-save-container">
    ...
    <button type="submit" form="itemForm" class="btn btn-primary floating-save-btn">
        <i class="bi bi-check-lg me-1"></i> Create Price Rule
    </button>
</div>
@endsection
...
<script>
    ...
    function showProductSearchResults(products) {
        // Create a dropdown-like div for results
