            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        <div class="text-muted small text-uppercase">Total Abandoned Carts</div>
                        <div class="h3 mb-0 text-primary">{{ $totalAbandoned }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        <div class="text-muted small text-uppercase">Recovered Carts</div>
                        <div class="h3 mb-0 text-success">{{ $recovered }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <div class="h3 mb-0 text-info">{{ $recoveryRate }}%</div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <div class="h3 mb-0 text-success">{{ '৳' . number_format($recoveredRevenue, 2) }}</div>
                    </div>
                </div>
            </div>
        </div>
