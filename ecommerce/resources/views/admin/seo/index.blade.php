...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-gear me-2"></i>SEO Settings</h4>
</div>
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <form action="{{ route('admin.seo.meta.update') }}" method="POST" id="seo-form">
                    ...
                    <div class="mb-3">
                        <label for="site_meta_title" class="form-label">Site Meta Title <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="site_meta_keywords" class="form-label">Site Meta Keywords</label>
                        <input type="text" id="site_meta_keywords" name="site_meta_keywords" class="form-control @error('site_meta_keywords') is-invalid @enderror" value="{{ old('site_meta_keywords', $settings['site_meta_keywords'] ?? '') }}" maxlength="500">
                    ...
                    <div class="mb-3">
                        <label for="google_search_console_code" class="form-label">Google Search Console Code</label>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    ...
                                    <p class="text-muted mb-2 mt-2">No redirects configured</p>
                                    <p class="text-muted small mb-0">Add a redirect above to manage URL redirects</p>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.seo.meta.update') }}" method="POST" id="og-form">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" form="og-form" class="btn btn-primary btn-sm">
                            <i class="bi bi-check-lg me-1"></i> Save OG Settings
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.seo.meta.update') }}" method="POST" id="twitter-form">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" form="twitter-form" class="btn btn-primary btn-sm">
                            <i class="bi bi-check-lg me-1"></i> Save Twitter Settings
                        </button>
                    </div>
                </form>
            </div>
