...
DROP TABLE IF EXISTS `abandoned_cart_records`;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `color_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `digital_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `login_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `login_codes_email_code_index` (`email`,`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `otp_sms_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `product_bundle_purchases`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `roles` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `guard_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `submenu_visibility` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `warehouse_city`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (2,'2024_01_01_000002_create_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (3,'2024_01_01_000003_create_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2024_01_01_000004_create_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2024_01_01_000005_create_carts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2024_01_01_000006_create_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2024_01_01_000007_create_seo_and_content_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2024_01_01_000008_create_coupons_reviews_chats_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2024_01_01_000009_add_hero_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2024_01_01_000010_add_items_column_to_carts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2026_02_18_141144_add_helpful_votes_to_reviews_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2026_02_18_145227_add_why_choose_us_settings',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2026_02_18_151752_add_product_section_columns_settings',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2026_02_19_102648_add_homepage_section_order_to_settings_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2026_02_19_120000_fix_blogs_category_foreign_key',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2026_02_19_130000_add_blog_settings',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2026_02_23_000001_create_affiliate_tables',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2026_02_23_100000_add_affiliate_id_to_banners',9);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2026_02_24_000001_add_product_code_to_products_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2026_02_24_000001_enhance_categories_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2026_02_24_100000_add_seller_fields_to_products_table',12);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2026_02_24_200000_add_digital_product_fields',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2026_02_24_300000_create_digital_categories_table',14);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2026_02_25_000001_add_discount_date_range_to_products_table',15);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2026_02_25_000001_create_brands_table',16);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2026_02_25_100000_create_attributes_table',17);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (27,'2026_02_25_100001_create_colors_table',18);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (28,'2026_02_25_200000_create_product_bundles_table',19);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (29,'2026_02_25_200000_create_related_products_table',20);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'2026_02_25_150000_create_product_qa_table',21);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'2026_02_26_000001_create_inventory_history_table',22);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2026_02_26_000001_add_order_type_to_orders_table',23);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2026_02_28_000001_create_pickup_points_table',24);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2026_02_28_000001_create_quotations_table',25);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2026_02_28_000002_create_quotation_items_table',26);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2026_02_28_000001_create_subscriptions_table',27);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2026_02_28_000001_create_delivery_partners_table',28);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2026_02_28_000002_create_carriers_table',29);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2026_02_28_000001_add_tracking_to_orders_table',30);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2026_03_01_000001_create_delivery_zones_table',31);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2026_03_01_000001_create_delivery_boys_table',32);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2026_03_01_000001_create_delivery_schedules_table',33);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2026_03_02_000001_create_refunds_table',34);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2026_03_02_000001_create_customer_groups_table',35);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2026_03_02_000001_create_customer_segments_table',36);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2026_03_02_120709_create_loyalty_points_tables',37);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2026_03_02_125913_create_membership_plans_table',38);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2026_03_02_000001_create_customer_wallet_tables',39);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2026_03_03_000001_create_sellers_table',40);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2026_03_04_000001_create_seller_payouts_table',41);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (51,'2026_03_05_000001_create_user_searches_table',42);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (52,'2026_03_06_000001_create_flash_deals_table',43);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (53,'2026_03_07_000001_create_push_notifications_table',100);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (54,'2026_03_07_000001_create_newsletters_table',101);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (55,'2026_03_07_000002_create_subscribers_table',102);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (56,'2026_03_07_000003_add_phone_to_subscribers_table',103);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (57,'2026_03_07_000001_create_abandoned_carts_table',104);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (58,'2026_03_07_000001_create_gift_cards_table',105);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (59,'2026_03_07_121701_create_price_rules_table',106);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (60,'2026_03_07_000001_create_tickets_table',107);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (61,'2026_03_07_130201_create_predefined_messages_table',108);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (62,'2026_03_08_000001_add_new_status_to_chats_table',109);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (63,'2026_03_08_000002_add_replied_status_to_chats_table',110);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (64,'2026_03_08_121300_add_guest_fields_to_chats_table',111);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (65,'2026_03_08_120000_add_typing_status_to_chats_table',112);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (66,'2026_03_10_000001_create_otp_tables',113);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (67,'2026_03_10_000002_add_missing_columns_to_blog_categories_table',114);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (68,'2026_03_10_000003_create_blog_tags_table',115);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (69,'2026_03_10_000004_create_blog_tag_pivot_table',116);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (70,'2026_03_10_120000_create_form_builder_tables',117);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (71,'2026_03_10_000005_create_faqs_table',118);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (72,'2026_03_10_000001_create_menus_table',119);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (73,'2026_03_10_000001_create_widgets_table',120);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (74,'2026_03_10_000001_add_button_color_to_sliders_table',121);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (75,'2026_03_10_000002_add_button_text_color_and_icon_to_sliders_table',122);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (76,'2026_03_10_000003_add_button_icon_color_to_sliders_table',123);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (77,'2026_03_07_000002_add_fields_to_banners_table',124);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (78,'2026_03_11_000001_create_languages_table',125);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (79,'2026_03_11_000002_create_currencies_table',126);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (80,'2026_03_11_000003_create_taxes_table',127);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (81,'2026_03_11_141445_add_is_default_to_payment_gateways_table',128);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (82,'2026_03_11_000001_add_shipping_method_to_orders_table',129);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (83,'2026_03_11_000004_create_email_templates_table',130);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (84,'2026_03_11_000002_create_user_notification_preferences_table',131);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (85,'2026_03_12_000001_create_api_keys_and_webhooks_tables',132);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (86,'2026_03_12_000001_create_warehouses_table',133);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (87,'2026_03_12_000001_create_addons_table',134);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (88,'2026_03_12_000004_create_stores_table',135);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (89,'2026_03_12_000005_add_store_id_to_products_table',136);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (90,'2026_03_12_000006_add_store_id_to_orders_table',137);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (91,'2026_03_14_000001_create_notifications_table',138);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (92,'2026_03_14_000002_add_missing_columns_to_activity_logs_table',139);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (93,'2026_03_14_114109_update_users_role_column_length',140);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (94,'2026_03_16_114122_add_thumbnail_to_products_table',141);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (95,'2026_03_18_add_thumbnail_to_categories_table',142);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (96,'2026_03_31_add_thumbnail_to_sliders_table',143);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (97,'2026_03_31_000001_add_thumbnail_to_banners_table',144);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (98,'2026_04_08_120412_add_featured_thumbnail_to_products_table',145);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (99,'2026_04_09_000002_add_price_and_image_to_attribute_values_table',146);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (100,'2026_04_09_151954_add_price_quantity_image_sku_to_product_attribute_values_table',147);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (101,'2026_04_13_095521_add_colors_column_to_products_table',148);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (102,'2026_04_15_171547_add_unique_constraint_to_product_code',149);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (103,'2026_02_25_100002_create_color_values_table',150);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (104,'2026_02_25_100002_add_is_filterable_to_colors_table',151);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (105,'2026_04_23_111944_add_is_visible_to_product_attribute_values_and_product_colors_tables',152);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (106,'2026_04_09_000001_add_parent_id_and_approval_to_products_table',147);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (107,'2026_04_26_120057_add_specs_to_products_table',153);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (108,'2026_04_27_000001_create_product_variant_images_table',154);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (109,'2026_05_03_000001_create_cities_table',155);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (110,'2026_05_03_000002_create_areas_table',155);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (111,'2026_05_03_000003_create_warehouse_city_table',155);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (112,'2026_05_03_000004_create_warehouse_area_table',155);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (113,'2026_05_03_000005_add_location_fields_to_orders_table',155);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (114,'2026_05_03_000006_create_countries_table',156);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (115,'2026_05_03_000007_add_country_id_to_cities_table',156);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (116,'2026_05_03_000008_create_states_table',157);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (117,'2026_05_03_000009_add_state_id_to_cities_table',158);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (118,'2026_05_04_102256_make_billing_email_and_postcode_nullable',159);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (119,'2026_05_04_102257_add_area_to_warehouses_table',160);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (120,'2026_05_04_153409_add_picking_fields_to_orders_table',161);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (121,'2026_05_04_163457_create_permission_tables',162);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (122,'2026_05_04_164000_rename_permissions_column',163);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (123,'2024_01_01_000011_add_social_login_fields',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (124,'2026_03_07_000001_create_banners_table',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (125,'2026_03_10_000001_create_blog_categories_table',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (126,'2026_03_10_104201_add_featured_image_to_pages_table',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (127,'2026_03_12_000002_add_staff_fields_to_users_table',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (128,'2026_03_12_000003_create_activity_logs_table',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (129,'2026_03_30_add_hero_type_setting',164);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (130,'2026_04_16_161152_add_thumbnail_to_affiliate_banners_table',165);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (131,'2026_05_18_123303_create_login_codes_table',166);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (132,'2026_05_20_123728_add_submenu_visibility_to_roles_table',167);
